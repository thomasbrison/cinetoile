...
<form class="formulaire" name="modification_film" method="post" action="films.php/modifier" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <p>
            <label>Acteurs : </label>
            <input type="text" name="acteurs" size="40" maxlength="128" value="<?php echo $acteurs; ?>" placeholder="Acteurs principaux"/>
        </p>
        <p>
            <label>Genre : </label>
    ...
    <fieldset>
        ...
        <p>
            ...
            <textarea name="synopsis" rows="5" cols="40" maxlength="2048">
                <?php echo $synopsis; ?>
            </textarea>
        </p>
        <p class="film">
