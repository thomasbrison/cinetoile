<form class="formulaire" name="<?php echo $form_name; ?>" method="post" action="<?php echo "$form_target/$form_action"; ?>" <?php if ('ajouter' === $form_action) echo 'onsubmit="return !loginExists;"'; ?>>
